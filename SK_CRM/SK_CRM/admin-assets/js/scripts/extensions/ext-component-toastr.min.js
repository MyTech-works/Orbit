$((function () {
    ...
    var t, o = "rtl" === $("html").attr("data-textdirection"),
        ...
        quotationsuccess = $("#quotation-success"),
        quotationupdated = $("#quotation-updated"),
        customersuccess = $("#customer-success"),
        customerupdated = $("#customer-updated"),
        mandatorymissing = $("#mandatory-missing"),
        insertedsuccess = $("#inserted"),
        updatedsuccess = $("#updated"),
        quoteproducts = $("#quotation-products");
    n.on("click", (function () {
        ...
        success.on("click", (function () {
            toastr.success("New product added successfully.", "Product Added", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        companysuccess.on("click", (function () {
            toastr.success("New company added successfully.", "Company Added", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        companyupdated.on("click", (function () {
            toastr.success("Company updated successfully.", "Company Updated", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        quotationsuccess.on("click", (function () {
            toastr.success("New quotation added successfully.", "Quotation Added", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        quotationupdated.on("click", (function () {
            toastr.success("Quotation updated successfully.", "Quotation Updated", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        customersuccess.on("click", (function () {
            toastr.success("New customer added successfully.", "Customer Added", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        customerupdated.on("click", (function () {
            toastr.success("Customer updated successfully.", "Customer Updated", {
                closeButton: !0,
                tapToDismiss: !1,
                progressBar: !0,
                rtl: o
        ...
        mandatorymissing.on("click", (function () {
            toastr.error("Mandatory data missing, Kindly check and update.", "Mandatory Missing!", {
                closeButton: !0,
                tapToDismiss: !1,
                rtl: o
            })
        ...
        quoteproducts.on("click", (function () {
            toastr.error("Please select at lease one product.", "Product not Selected!", {
                closeButton: !0,
                tapToDismiss: !1,
                rtl: o
            })
        ...
        insertedsuccess.on("click", (function () {
        ...
        updatedsuccess.on("click", (function () {

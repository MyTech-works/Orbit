...
window.colors = {
    ...
    function (a, e, t) {
        ...
        if ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")),
            ...
            t(a).on("load", (function () {
                var r = !1;
                (n.hasClass("menu-collapsed") || "true" === localStorage.getItem("menuCollapsed")) && (r = !0),
                ...
                var l = n.data("menu");
                "horizontal-menu" != l && !1 === r && t(".main-menu-content").find("li.active").parents("li").addClass("open"),
                    "horizontal-menu" == l && (t(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"),
                    ...
                    !function (e, s) {
                        ...
                        t(".char-count").html(e.value.length),
                            e.value.length > n ? (r.css("background-color", a.colors.solid.danger),
                                ...
                                l.addClass("max-limit")) : (r.css("background-color", a.colors.solid.primary),
                                    l.css("color", o),
        ...
        if (t(e).on("click", ".menu-toggle, .modern-nav-toggle", (function (e) {
            return e.preventDefault(),
                ...
                n.hasClass("menu-expanded") || n.hasClass("menu-open") ? localStorage.setItem("menuCollapsed", !1) : localStorage.setItem("menuCollapsed", !0),
                !1
        }
        )),
        ...
        t(".search-list-main").mouseenter((function () {
                    ...
                    if (t("ul.search-list li").remove(),
                        ...
                        t.getJSON(r + "data/" + p + ".json", (function (a) {
                            for (var m = 0; m < a.listItems.length; m++) {
                                if ("laravel" === t("body").attr("data-framework") && (a.listItems[m].url = r + a.listItems[m].url),
                                    !0 === n) {
                                    s = "";
                                ...
                                0 == a.listItems[m].name.toLowerCase().indexOf(e) && f < 5 && (o += '<li class="auto-suggestion ' + (0 === f ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + a.listItems[m].url + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[a.listItems[m].icon].toSvg({
                                    class: "me-75 "
                                }) + "<span>" + a.listItems[m].name + "</span></div>" + h + "</a></li>",
                                    f++)
                            }
                            for (m = 0; m < a.listItems.length; m++) {
                                if (!0 === n) {
                                    s = "";
                                    for (p = t("ul.nav.navbar-nav.bookmark-icons li"),
                                        v = 0; v < p.length; v++)
                            ...
                            u = t(".main-search-list-defaultlist").html(),
                                "" == o && "" == l && (l = t(".main-search-list-defaultlist-other-list").html()),
                                i = d.concat(o, l, u),
            ...
            t(e).on("click", ".bookmark-input .search-list .bookmark-icon", (function (a) {
                if (a.stopPropagation(),
                    ...
                    t(this).addClass("text-warning"),
                        a.preventDefault();
                    var n, o = t(this).parent()[0].href, r = t(this).parent()[0].innerText, l = t(this).parent()[0].firstChild.firstChild.dataset.icon;
                    if (t(t(this).parent()[0].firstChild.firstChild).hasClass("feather"))
                        l = t(this).parent()[0].firstChild.firstChild.getAttribute("class").split("feather-")[1].split(" ")[0];
            ...
            t(a).on("scroll", (function () {
                (t(this).scrollTop() > 400 ? t(".scroll-top").fadeIn() : t(".scroll-top").fadeOut(),
                    n.hasClass("navbar-static")) && (t(a).scrollTop() > 65 ? (t("html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed").css({
                        background: "#fff",
                        ...
                        t(".dark-layout .horizontal-menu .horizontal-menu-wrapper.header-navbar").css("background", "#161d31")) : (t("html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed").css({
                            background: "#f8f8f8",
                            "box-shadow": "none"
                        }),
            ...
            e = "dark-layout" !== a ? "dark-layout" : a === n ? "light-layout" : n || "light-layout",
                ...
                function (a) {
                    ...
                    s.removeClass("semi-dark-layout dark-layout bordered-layout"),
                        "dark-layout" === l ? (s.addClass("dark-layout"),
                            o.removeClass("menu-light").addClass("menu-dark"),
                            r.removeClass("navbar-light").addClass("navbar-dark"),
                            e.find(".ficon").replaceWith(feather.icons.sun.toSvg({
                                class: "ficon"
                            }))) : "bordered-layout" === l ? (s.addClass("bordered-layout"),
                                o.removeClass("menu-dark").addClass("menu-light"),
                                r.removeClass("navbar-dark").addClass("navbar-light"),
                                e.find(".ficon").replaceWith(feather.icons.moon.toSvg({
                                    class: "ficon"
                                }))) : "semi-dark-layout" === l ? (s.addClass("semi-dark-layout"),
                                    o.removeClass("menu-dark").addClass("menu-light"),
                                    r.removeClass("navbar-dark").addClass("navbar-light"),
                                    e.find(".ficon").replaceWith(feather.icons.moon.toSvg({
                                        class: "ficon"
    ...
    "function" == typeof jQuery.validator && jQuery.validator.setDefaults({
        ...
        errorPlacement: function (a, e) {
            e.parent().hasClass("input-group") || e.hasClass("select2") || "checkbox" === e.attr("type") ? a.insertAfter(e.parent()) : e.hasClass("form-check-input") ? a.insertAfter(e.parent().siblings(":last")) : a.insertAfter(e),

    ...
    a(["jquery"], function (a) {
        return function () {
            ...
            function o(c) {
                var d = v();
                return b || i(d),
                    c && 0 === a(":focus", c).length ? void w(c) : void (b.children().length && b.remove())
            }
            function p(c) {
            ...
            function r(c) {
                return b = a("<div/>").attr("id", c.containerId).addClass("toast-container").addClass(c.positionClass),
            ...
            function u(c) {
                ...
                function x() {
                    j.hide(),
                        ...
                        e.timeOut > 0 && (h = setTimeout(G, e.timeOut),
                ...
                function C() {
                    e.closeButton && (n.addClass(e.closeClass).attr("role", "button"),
                        j.prepend(n))
                }
                function D() {
                    e.progressBar && (m.addClass(e.progressClass),
                        j.prepend(m))
                }
                function E() {
                ...
                function G(b) {
                    ...
                    if (!a(":focus", j).length || b)
                        return clearTimeout(o.intervalId),
                            j[c]({
                                duration: d,
                                easing: f,
                                complete: function () {
                ...
                function H() {
                    (e.timeOut > 0 || e.extendedTimeOut > 0) && (h = setTimeout(G, e.extendedTimeOut),
                ...
                if ("undefined" != typeof c.optionsOverride && (e = a.extend(e, c.optionsOverride),
